...
export function PainPointsSection() {
  return (
    <section className="relative py-32 bg-[#06060a] overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h2 className="text-[clamp(1.5rem,3.5vw,2.5rem)] leading-[1.08] tracking-[-0.03em] font-extrabold text-white">
                ...
                <div className="border-t border-white/[0.06] mt-7 pt-5">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="text-[36px] font-extrabold tracking-[-0.03em] bg-gradient-to-r from-[#818cf8] to-[#c084fc] bg-clip-text text-transparent cursor-default">{card.stat}</span>
                    </TooltipTrigger>
