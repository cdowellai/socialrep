...
export function PricingSection() {
  ...
  const displayPlans = [
    { name: "Starter", planKey: "starter", monthlyPrice: starterPlan?.monthly_price || 79, annualPrice: starterPlan?.annual_price || 63, description: "For businesses getting started.", features: planFeatures.starter, recommended: false, plan: starterPlan },
    { name: "Professional", planKey: "professional", monthlyPrice: professionalPlan?.monthly_price || 199, annualPrice: professionalPlan?.annual_price || 159, description: "For growing businesses that need it all.", features: planFeatures.professional, recommended: true, plan: professionalPlan },
    { name: "Agency", planKey: "agency", monthlyPrice: agencyPlan?.monthly_price || 499, annualPrice: agencyPlan?.annual_price || 399, description: "For teams managing multiple clients.", features: planFeatures.agency, recommended: false, plan: agencyPlan },
  ];
